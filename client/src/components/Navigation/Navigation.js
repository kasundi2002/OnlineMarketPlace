      ...
      <Nav>
        <NavbarContainer>
          ...
          <NavMenu click={click}>
            ...
            <NavItem>
              <NavLinks active={newsFeed} to="/news" onClick={clickHandler}>
                News
              </NavLinks>
            </NavItem>
            <NavItem>
              <NavLinks active={newsFeed} to="/allshop" onClick={clickHandler}>
                Shops
              </NavLinks>
            </NavItem>
            <NavItem>
              {mobile
                ?
                  <MobileNavItem active={shop}>Products</MobileNavItem>
                :
                  <NavLinks active={shop} to="/shop">Products</NavLinks>
              }
              <SubMenu>
                <SubItem>
